...
Завдання: на основі даних про вихідні (субота та неділя) напиши короткий, дружній прогноз на 2 абзаци — по одному на кожен день. Пиши природно, як у спільному чаті: температура від такої вночі до такої вдень, умови, чи буде дощ, вітер. Не використовуй крапки-роздільники (·), не пиши у вигляді списків з буллетами. Один-два речення на день — достатньо. Наприклад: «У суботу буде сонячно, від 4° вночі до 13° вдень…»`;
  }
