...
Напиши 3–6 речень живою розмовною мовою, ніби пишеш другові: чи є в цьому шматку прогнозу помітніші тепліші дні, чи все ще «сидимо в прохолоді», чи з’являється хоча б коротке передихання. Якщо тиждень суворий — скажи чесно, але без драми й без фраз на кшталт «неможливо відповісти», «немає даних», «не можу». Не вигадуй дат і чисел — спирайся лише на надані рядки. Не згадуй технічні сервіси, API чи назви моделей. Без HTML і без markdown; можна два короткі абзаци через порожній рядок. Не переписуй таблицю дослівно — коментуй настрій тижня й що це може означати для відчуття на вулиці.`;
  }
