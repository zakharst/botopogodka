...
export function getFallbackOutfit(weatherData, profileKey) {
  ...
  if (temp != null) {
    if (temp < -5) {
      ...
      if (profileKey === 'run') bullets.push('На пробіжку — вдягайся на шар легше, буде тепліше від руху.');
      ...
      if (profileKey === 'run') bullets.push('На пробіжку — легкий, дихаючий одяг, буде тепліше від руху.');
      if (profileKey === 'bike') bullets.push('На велосипеді — достатньо легко, вітер при їзді охолоджує.');
    } else {
