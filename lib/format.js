...
export function formatTimeSettings(user) {
  ...
  const e = user.autopostEvening ? 'Увімкнено' : 'Вимкнено';
  let t = '⏰ <b>Налаштування часу</b>\n\n';
  t += `Ранковий автопост (локальний час міста): ${m}\n`;
  t += `Час: ${user.morningTime || '07:30'}\n\n`;
  t += `Вечірній автопост: ${e}\n`;
  t += `Час: ${user.eveningTime || '20:00'}\n\n`;
  t += 'Натисніть кнопки нижче, щоб увімкнути/вимкнути або ввести свій час (наприклад 07:30).';
  return t;
}
