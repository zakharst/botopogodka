 ...
 * @returns {{ ok: true, header: string, bodyBlock: string, footer: string, dataForAi: string } | { ok: false, fallbackFullMessage: string }}
 */
export function buildForecastPeriodStructured(forecastData, cityDisplay, periodDays) {
  ...
  return { ok: true, header, bodyBlock, footer, dataForAi: lines.join('\n') };
}
...
export function formatForecastWeek(forecastData, cityDisplay) {
  ...
  return s.header + s.bodyBlock + s.footer;
}
